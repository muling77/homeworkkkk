...
# 111 "../../../Library/StdDriver/src/clk.c"
void CLK_Idle(void)
{
...
# 152 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetLXTFreq(void)
{
    uint32_t u32Freq;
...
# 267 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetCPUFreq(void)
{
    SystemCoreClockUpdate();
    return SystemCoreClock;
}
# 282 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    uint32_t u32HIRCSTB;
...
# 350 "../../../Library/StdDriver/src/clk.c"
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
...
# 675 "../../../Library/StdDriver/src/clk.c"
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
...
# 753 "../../../Library/StdDriver/src/clk.c"
void CLK_SetSysTickClockSrc(uint32_t u32ClkSrc)
{
...
# 787 "../../../Library/StdDriver/src/clk.c"
void CLK_DisableXtalRC(uint32_t u32ClkMask)
{
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PWRCTL &= ~u32ClkMask;
}
...
# 1017 "../../../Library/StdDriver/src/clk.c"
void CLK_DisableModuleClock(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if((u32PllFreq <= 500000000UL) && (u32PllFreq >= 50000000UL))
    {
        ...
        for(u32NR = 1UL; u32NR <= 32UL; u32NR++)
        {
            ...
            {
                for(u32NF = 2UL; u32NF <= 100UL; u32NF++)
...
# 1211 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
...
# 1242 "../../../Library/StdDriver/src/clk.c"
void CLK_EnableSysTick(uint32_t u32ClkSrc, uint32_t u32Count)
{
...
# 1378 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetPMUWKSrc(void)
{
    return (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PMUSTS);
}
# 1398 "../../../Library/StdDriver/src/clk.c"
void CLK_EnableSPDWKPin(uint32_t u32Port, uint32_t u32Pin, uint32_t u32TriggerType, uint32_t u32DebounceEn)
{
...
# 1525 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockSource(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
    uint32_t au32SelTbl[5] = {0x0UL, 0x4UL, 0x8UL, 0xCUL, 0x4CUL};
...
# 1598 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockDivider(uint32_t u32ModuleIdx)
{
...
# 1639 "../../../Library/StdDriver/src/clk.c"
void CLK_DisablePLLFN(void)
{
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLFNCTL1 |= (0x1ul << (28));
}
# 1654 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_EnablePLLFN(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if((u32PllFreq > 500000000UL) || (u32PllFreq < 50000000UL) || (u32NR==33) )
    {
        if(u32PllClkSrc == 0x00000000UL)
        {
            ...
            ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLFNCTL1 = 0x00000000UL;
        ...
        else
        {
            ...
            ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLFNCTL0 = (0x00000000UL | (((2UL)-1UL)<<9) | (((32UL)-2UL)) | 0x4000UL);
            ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLFNCTL1 = (0x1ul << (31));
...
# 1786 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetPLLFNClockFreq(void)
{
