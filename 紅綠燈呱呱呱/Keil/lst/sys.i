...
# 208 "../../../Library/StdDriver/src/sys.c"
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
...
# 240 "../../../Library/StdDriver/src/sys.c"
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
...
# 256 "../../../Library/StdDriver/src/sys.c"
void SYS_DisableBOD(void)
{
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->BODCTL &= ~(0x1ul << (0));
}
# 271 "../../../Library/StdDriver/src/sys.c"
int32_t SYS_SetPowerLevel(uint32_t u32PowerLevel)
{
...
# 307 "../../../Library/StdDriver/src/sys.c"
void SYS_SetVRef(uint32_t u32VRefCTL)
{
